...
public class BanqueController implements Serializable {
    ...
    @EJB
    private SessionBeans.BanqueFacade ejbFacade;
...
private String page;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Banque) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private BanqueFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Banque o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Banque o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Banque c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class BanqueControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
         ...
         try{   BanqueController controller = (BanqueController) facesContext.getApplication().getELResolver().
