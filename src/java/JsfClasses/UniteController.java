...
public class UniteController implements Serializable {
    ...
    @EJB
    private SessionBeans.UniteFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    private UniteFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Unite o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Unite o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Unite c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class UniteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
         ...
         try{   UniteController controller = (UniteController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Unite) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + UniteController.class.getName());
            }
        }
    }
}
