...
public class FournisseurController implements Serializable {
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Fournisseur) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private FournisseurFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Fournisseur o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Fournisseur o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Fournisseur c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class FournisseurControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
          ...
          try{  FournisseurController controller = (FournisseurController) facesContext.getApplication().getELResolver().
