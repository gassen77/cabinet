...
public class FamilleController implements Serializable {
    ...
    @EJB
    private SessionBeans.FamilleFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Famille) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private FamilleFacade getFacade() {
      ...
      public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Famille o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Famille o where ";
   ...
   page = "Create";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Famille c");
         if (l==null)
           {
            l = new Long(1);
           }
        ...
        catch(Exception e)
        {
            ...
            JsfUtil.addErrorMessage("Transaction reussi");
            return null;
        }
    }
    ...
    public static class FamilleControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ FamilleController controller = (FamilleController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Famille) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + FamilleController.class.getName());
            }
        }
    }
}
