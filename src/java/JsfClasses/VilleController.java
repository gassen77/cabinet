...
public class VilleController implements Serializable {
    ...
    @EJB
    private SessionBeans.VilleFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    public String rechercherListItems(){
        String requette="Select o from Ville o where ";
    ...
    private void updateCurrentItem() {
        ...
        if (selectedItemIndex >= 0) {
            current = (Ville) getFacade().findRange(new int[]{selectedItemIndex, selectedItemIndex + 1}).get(0);
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(abstractFacade.findAll(), false);
    }

    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItems(abstractFacade.findAll(), true);
    }
    ...
    public static class VilleControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ VilleController controller = (VilleController) facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(), null, "villeController");
            return controller.getFacade().find(getKey(value));}catch(Exception e){return null;}
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Ville) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + VilleController.class.getName());
            }
        }
