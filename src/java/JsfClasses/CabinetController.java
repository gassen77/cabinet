...
@ManagedBean(name = "cabinetController")
@ViewScoped
public class CabinetController implements Serializable {
    ...
    @EJB
    private SessionBeans.CabinetFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Cabinet) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private CabinetFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Cabinet o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Cabinet o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Cabinet c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class CabinetControllerConverter implements Converter {
      ...
      try{      CabinetController controller = (CabinetController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cabinet) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CabinetController.class.getName());
            }
        }
    }
}
