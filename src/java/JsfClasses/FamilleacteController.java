...
@ManagedBean(name = "familleacteController")
@ViewScoped
public class FamilleacteController implements Serializable {

    private Familleacte current;
    private DataModel items = null;
    @EJB
    private SessionBeans.FamilleacteFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Familleacte) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public FamilleacteController() {
    }

    public Familleacte getSelected() {
        if (current == null) {
            current = new Familleacte();
            selectedItemIndex = -1;
        }
    ...
    private FamilleacteFacade getFacade() {
        return ejbFacade;
    }
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Familleacte o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Familleacte o where ";
    ...
    public String prepareList() {
        ...
        map.put("mapRechercheList",mapRechercheList);
          return "List_familleacte";
    }

    public String prepareView() {
        current = (Familleacte) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Familleacte c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public String update() {
        try {
           ...
           JsfUtil.addSuccessMessage("Transaction reussi");
            ...
            JsfUtil.addSuccessMessage("Transaction echouee");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("FamilleacteDeleted"));
        } catch (Exception e) {
    ...
    @FacesConverter(forClass = Familleacte.class)
    public static class FamilleacteControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
           try{ FamilleacteController controller = (FamilleacteController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "familleacteController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Familleacte) {
                Familleacte o = (Familleacte) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + FamilleacteController.class.getName());
            }
        }
    }
}
