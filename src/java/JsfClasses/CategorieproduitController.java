...
public class CategorieproduitController implements Serializable {
    ...
    @EJB
    private SessionBeans.CategorieproduitFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Categorieproduit) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private CategorieproduitFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Categorieproduit o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Categorieproduit o where ";
    ...
    public String prepareCreate() {
        ...
        map.put("page", page);
        map.put("current", current);
        return "Create_categorieproduit";
    }
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Categorieproduit c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class CategorieproduitControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
          ...
          try{  CategorieproduitController controller = (CategorieproduitController) facesContext.getApplication().getELResolver().
