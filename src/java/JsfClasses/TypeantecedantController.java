...
@ManagedBean(name = "typeantecedantController")
@ViewScoped
public class TypeantecedantController implements Serializable {

    private Typeantecedant current;
    private DataModel items = null;
    @EJB
    private SessionBeans.TypeantecedantFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Typeantecedant) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public TypeantecedantController() {
       
       
    }

    public Typeantecedant getSelected() {
        if (current == null) {
            current = new Typeantecedant();
            selectedItemIndex = -1;
        }
    ...
    private TypeantecedantFacade getFacade() {
        return ejbFacade;
    }
   ...
   public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Typeantecedant o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Typeantecedant o where ";
    ...
    public String prepareList() {
        ...
        return "List_typeantecedant";
    }

    public String prepareView() {
        current = (Typeantecedant) getItems().getRowData();
    ...
    public String prepareCreate() {
       page = "Create";
        ...
        map.put("page", page);
        map.put("current", current);
        return "Create_typeantecedant";
    }

    
    public String create() {
        try {
      //      current.setId(new Long(1));
              Long l = new Long(1);
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Ville c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Typeantecedant.class)
    public static class TypeantecedantControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
          try{  TypeantecedantController controller = (TypeantecedantController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "typeantecedantController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Typeantecedant) {
                Typeantecedant o = (Typeantecedant) object;
              return getStringKey(o.getId());
              
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TypeantecedantController.class.getName());
            }
        }
    }
}
