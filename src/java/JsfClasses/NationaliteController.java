...
public class NationaliteController implements Serializable {
    ...
    @EJB
    private SessionBeans.NationaliteFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Nationalite) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Nationalite o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Nationalite o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Nationalite c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class NationaliteControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
          ...
          try{  NationaliteController controller = (NationaliteController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Nationalite) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + NationaliteController.class.getName());
            }
        }
    }
}
