...
import SessionBeans.ConventionFacade;
...
@ManagedBean(name = "conventionController")
@ViewScoped
public class ConventionController implements Serializable {

    private Convention current;
    private DataModel items = null;
    @EJB
    private SessionBeans.ConventionFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
                current = (Convention) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private ConventionFacade getFacade() {
        return ejbFacade;
    }
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Convention o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Convention o where ";
    ...
    public String prepareList() {
      recreateModel();
        ...
        return "List_convention";
    }

    public String prepareView() {
        current = (Convention) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Convention c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Convention.class)
    public static class ConventionControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
          try{  ConventionController controller = (ConventionController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "conventionController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Convention) {
                Convention o = (Convention) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ConventionController.class.getName());
            }
        }
    }
}
