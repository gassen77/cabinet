...
@ManagedBean(name = "laboratoireController")
@ViewScoped
public class LaboratoireController implements Serializable {
    ...
    @EJB
    private SessionBeans.LaboratoireFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Laboratoire) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private LaboratoireFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Laboratoire o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Laboratoire o where ";
    ...
    public String prepareList() {
       ...
       FacesContext fc=FacesContext.getCurrentInstance();
        ...
        return "List_laboratoire";
    }

    public String prepareView() {
        current = (Laboratoire) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Laboratoire c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class LaboratoireControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ LaboratoireController controller = (LaboratoireController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Laboratoire) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + LaboratoireController.class.getName());
            }
        }
    }
}
