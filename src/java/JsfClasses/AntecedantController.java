...
import SessionBeans.AntecedantFacade;

import SessionBeans.TypeantecedantFacade;
...
@ManagedBean(name = "antecedantController")
@ViewScoped
public class AntecedantController implements Serializable {

    private Antecedant current;
    private DataModel items = null;
    @EJB
    private SessionBeans.AntecedantFacade ejbFacade;
    ...
    private Map<String,Object>mapRechercheList;
     @EJB
    private TypeantecedantFacade ejbtypeantecedant;
    public AntecedantController() {
          FacesContext fc = FacesContext.getCurrentInstance();
          ejbtypeantecedant = (TypeantecedantFacade) fc.getApplication().getELResolver().getValue(fc.getELContext(), null, "TypeantecedantJpa");
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Antecedant) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private AntecedantFacade getFacade() {
        return ejbFacade;
    }
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Antecedant o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Antecedant o where ";
    ...
    public String prepareList() {
        ...
        return "List_antecedant";
    }

    public String prepareView() {
        current = (Antecedant) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        return "View";
    }

     public List<Typeantecedant> autocompleteTypeAntecedant(String code) {
        List<Typeantecedant> result = new ArrayList<Typeantecedant>();
        try {
            result = (List<Typeantecedant>) requeteTypeAntecedant(code);
            return result;
        } catch (Exception d) {
            result = new ArrayList<Typeantecedant>();
            return result;
        }
    }

    public List<Typeantecedant> requeteTypeAntecedant(String code) {
        String q = "Select b from Typeantecedant b where b.code like :code or b.libelle like :code";
        List<Typeantecedant> l = this.ejbtypeantecedant.findByParameterAutocomplete(q, "code", code + "%", 50);
        return l;
    }
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Antecedant c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Antecedant.class)
    public static class AntecedantControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            try
            {
            AntecedantController controller = (AntecedantController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "antecedantController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Antecedant) {
                Antecedant o = (Antecedant) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + AntecedantController.class.getName());
            }
        }
    }
}
