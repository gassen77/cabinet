...
public class TvaController implements Serializable {
    ...
    @EJB
    private SessionBeans.TvaFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Tva o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Tva o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Tva c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class TvaControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
          ...
          try{  TvaController controller = (TvaController) facesContext.getApplication().getELResolver().
