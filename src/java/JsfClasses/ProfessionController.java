...
public class ProfessionController implements Serializable {
    ...
    @EJB
    private SessionBeans.ProfessionFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Profession) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Profession o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Profession o where ";
    ...
    public String prepareView() {
        current = (Profession) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Profession c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public String prepareEdit() {
        System.out.println("fct prepare edit ");
        current = (Profession) getItems().getRowData();
        selectedItemIndex = pagination.getPageFirstItem() + getItems().getRowIndex();
        page = "Edit";
    ...
    public static class ProfessionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ ProfessionController controller = (ProfessionController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Profession) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ProfessionController.class.getName());
            }
        }
    }
}
