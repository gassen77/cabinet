...
@ManagedBean(name = "modereglementController")
@ViewScoped
public class ModereglementController implements Serializable {

    private Modereglement current;
    private DataModel items = null;
    @EJB
    private SessionBeans.ModereglementFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Modereglement) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public ModereglementController() {
    }

    public Modereglement getSelected() {
        if (current == null) {
            current = new Modereglement();
            selectedItemIndex = -1;
        }
    ...
    private ModereglementFacade getFacade() {
        return ejbFacade;
    }
  ...
  public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Modereglement o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Modereglement o where ";
    ...
    public String prepareList() {
        ...
        return "List_modereglement";
    }

    public String prepareView() {
        current = (Modereglement) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Modereglement c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Modereglement.class)
    public static class ModereglementControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
           try{ ModereglementController controller = (ModereglementController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "modereglementController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Modereglement) {
                Modereglement o = (Modereglement) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ModereglementController.class.getName());
            }
        }
    }
}
