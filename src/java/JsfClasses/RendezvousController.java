...
import SessionBeans.RendezvousFacade;
...
public class RendezvousController implements Serializable {
    ...
    @EJB
    private SessionBeans.RendezvousFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Rendezvous) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
     ...
     public void initPrepareCreate() {
          ...
          current.setDaterendezvous(new Date());
        selectedItemIndex = -1;
    }
    ...
    private RendezvousFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Rendezvous o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Rendezvous o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Rendezvous c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class RendezvousControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
          ...
          try{  RendezvousController controller = (RendezvousController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Rendezvous) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + RendezvousController.class.getName());
            }
        }
    }
}
