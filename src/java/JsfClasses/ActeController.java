...
@ManagedBean(name = "acteController")
@ViewScoped
public class ActeController implements Serializable {

    private Acte current;
    private DataModel items = null;
    @EJB
    private SessionBeans.ActeFacade ejbFacade;
      @EJB
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    private ActeFacade getFacade() {
     ...
     public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Acte o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Acte o where ";
    ...
    public String prepareView() {
        current = (Acte) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Acte c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Acte.class)
    public static class ActeControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
           try{ ActeController controller = (ActeController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "acteController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Acte) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ActeController.class.getName());
            }
        }
    }
}
