...
@ManagedBean(name = "dentController")
@ViewScoped
public class DentController implements Serializable {

    private Dent current;
    private DataModel items = null;
    @EJB
    private SessionBeans.DentFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    public DentController() {
    }

    public Dent getSelected() {
        if (current == null) {
            current = new Dent();
            selectedItemIndex = -1;
        }
   ...
   public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Dent o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Dent o where ";
   ...
   FacesContext fc=FacesContext.getCurrentInstance();
    ...
    public String prepareView() {
        current = (Dent) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Dent c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Dent.class)
    public static class DentControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
       try{     DentController controller = (DentController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "dentController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Dent) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DentController.class.getName());
            }
        }
    }
}
