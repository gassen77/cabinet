...
@ManagedBean(name = "classeClientController")
@ViewScoped
public class ClasseClientController implements Serializable {

    private ClasseClient current;
    private DataModel items = null;
    @EJB
    private SessionBeans.ClasseClientFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (ClasseClient) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public ClasseClientController() {
    }

    public ClasseClient getSelected() {
        if (current == null) {
            current = new ClasseClient();
            selectedItemIndex = -1;
        }
    ...
    private ClasseClientFacade getFacade() {
        return ejbFacade;
    }
      ...
      public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from ClasseClient o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from ClasseClient o where ";
    ...
    public String prepareList() {
        ...
        return "List_classeclient";
    }

    public String prepareView() {
        current = (ClasseClient) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from ClasseClient c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = ClasseClient.class)
    public static class ClasseClientControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
          try{  ClasseClientController controller = (ClasseClientController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "classeClientController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ClasseClient) {
                ClasseClient o = (ClasseClient) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ClasseClientController.class.getName());
            }
        }
    }
}
