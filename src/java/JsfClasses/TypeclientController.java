...
@ManagedBean(name = "typeclientController")
@ViewScoped
public class TypeclientController implements Serializable {

    private Typeclient current;
    private DataModel items = null;
    @EJB
    private SessionBeans.TypeclientFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Typeclient) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    private TypeclientFacade getFacade() {
        return ejbFacade;
    }
  public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Typeclient o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Typeclient o where ";
    ...
    public String prepareList() {
        ...
        return "List_typeclient";
    }

    public String prepareView() {
        current = (Typeclient) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Typeclient c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Typeclient.class)
    public static class TypeclientControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
          try{  TypeclientController controller = (TypeclientController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "typeclientController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Typeclient) {
                Typeclient o = (Typeclient) object;
                return getStringKey(o.getId());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TypeclientController.class.getName());
            }
        }
    }
}
