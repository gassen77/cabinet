...
public class SexeController implements Serializable {
    ...
    @EJB
    private SessionBeans.SexeFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    private SexeFacade getFacade() {
      ...
      public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Sexe o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Sexe o where ";
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Sexe c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class SexeControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ SexeController controller = (SexeController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sexe) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + SexeController.class.getName());
            }
        }
    }
}
