...
public class DepotController implements Serializable {
    ...
    @EJB
    private SessionBeans.DepotFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Depot o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Depot o where ";
    ...
    public String prepareView() {
        current = (Depot) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Depot c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    @FacesConverter(forClass = Depot.class)
    public static class DepotControllerConverter implements Converter {

        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            if (value == null || value.length() == 0) {
                return null;
            }
           try{ DepotController controller = (DepotController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "depotController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Depot) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + DepotController.class.getName());
            }
        }
    }
}
