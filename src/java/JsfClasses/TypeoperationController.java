...
public class TypeoperationController implements Serializable {
    ...
    private Typeoperation current;
    private DataModel items = null;
    @EJB
    private SessionBeans.TypeoperationFacade ejbFacade;
 ...
 FacesContext fc=FacesContext.getCurrentInstance();
        ...
        try {
            current = (Typeoperation) map.get("current");
        } catch (Exception e) {
            current = null;
        }
                try{
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            ...
            pagination = new PaginationHelper(10,"Select o from Typeoperation o",s,o) {
    ...
    public String rechercherListItems(){
        String requette="Select o from Typeoperation o where ";
    ...
    public String prepareList() {
        ...
        return "List_typeoperation";
    }

    public String prepareView() {
        current = (Typeoperation) getItems().getRowData();
    ...
    public String create() {
        ...
        try
        {
         l = getFacade().findByParameterSingleResultCountsansparam("Select max(c.id) from Typeoperation c");
         if (l==null)
           {
            l = new Long(1);
           }
    ...
    public static class TypeoperationControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
           ...
           try{ TypeoperationController controller = (TypeoperationController) facesContext.getApplication().getELResolver().
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Typeoperation) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + TypeoperationController.class.getName());
            }
        }
    }
}
